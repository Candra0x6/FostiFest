    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-screen-xl px-16 py-32 lg:flex sm:h-screen lg:items-center">
        <div className="mx-auto max-w-3xl text-center">
          <div className="py-[8px] px-6 rounded-xl border border-blue-600 text-blue-600 w-fit mx-auto mb-8 text-sm">Good Health and Well Being</div>
          <h1 className="text-2xl font-bold sm:text-[44px] opacity-85">
            Deteksi Dini untuk
            <span className="sm:block mt-6 leading-[1.4]"> Masa Depan Lebih Sehat</span>
          </h1>
